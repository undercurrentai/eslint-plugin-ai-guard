...
| `--force` | Overwrite existing files automatically (useful for updating rules after an `@undercurrentai/eslint-plugin-ai-guard` version upgrade). |
