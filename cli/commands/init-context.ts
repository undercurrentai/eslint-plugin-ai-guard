...
This project uses @undercurrent/eslint-plugin-ai-guard to catch the 17 most common
...
export function registerInitContextCommand(program: Command): void {
  program
    ...
    .description(
      ...
      'so Claude Code, Cursor, and GitHub Copilot avoid the 17 most common AI anti-patterns.',
    )
    ...
    .action(async (opts: {
      ...
      if (isDryRun) {
        ...
        if (createdCount > 0) {
          log.success(
            'Done. Your AI agents will now automatically avoid the 17 most common AI-generated code anti-patterns.',
          );
        }
      }
